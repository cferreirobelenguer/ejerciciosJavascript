...
function distributeGifts(packOfGifts, reindeers) {
    var gifs = 0;
    var renos = 0;
    for (var _i = 0, packOfGifts_1 = packOfGifts; _i < packOfGifts_1.length; _i++) {
        var i = packOfGifts_1[_i];
        var giftNumber = i.length;
        gifs += giftNumber;
    }
    for (var _a = 0, reindeers_1 = reindeers; _a < reindeers_1.length; _a++) {
        var i = reindeers_1[_a];
        var renoNumber = i.length;
        renos += (renoNumber * 2);
    }
    var total = Math.trunc(renos / gifs);
    return total;
}
